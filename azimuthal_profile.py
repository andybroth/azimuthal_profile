...
def make_radial_profile(a_arr, r_arr, cdens_arr, a_bins, r_bins, a_n_bins, r_n_bins):
  ...
  profile_data = [np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins]),np.zeros([3, r_n_bins])]
  '''
